...
class Pokemon:
    def __init__(self, nombre, tipos, movimientos, EVs, puntos_de_salud='============='):
        ...
        self.barras = 20 # Cantidad de barras de puntos_de_salud
    ...
    def ventaja(self, Pokemon2):
        ...
        version = ['fuego', 'aagua', 'planta']
        cadena_1_ataque = '\nEs moderadamente efectivo...'
        cadena_2_ataque = '\nEs moderadamente efectivo...'
    ...
    def turno(self, Pokemon2, cadena_1_ataque, cadena_2_ataque):
        ...
        los nuevos puntos de salud. Haz lo mismo con Pokemon2. Siga hasta que los puntos de salud de los pokemon sean < 0
        Actualiza los datos.'''
        while (self.barras > 0) and (Pokemon2.barras > 0):
            ...
            # Agregar barras adicionales más defensa
...
if __name__ == '__main__':
    ...
    Blastoise = Pokemon('Blastoise', 'aagua', ['Pistola Aagua', 'Rayo Burbuja', 'Hydro Pump', 'Surf'], {'ataque': 10, 'defensa': 10})
    ...
    Squirtle = Pokemon('Squirtle', 'aagua', ['Rayo Burbuja', 'Tackle', 'Headbutt', 'Surf'], {'ataque': 3, 'defensa': 3})
    ...
    Wartortle = Pokemon('Wartortle', 'aagua', ['Rayo Burbuja', 'Pistola Aagua', 'Headbutt', 'Surf'], {'ataque': 5, 'defensa': 5})
